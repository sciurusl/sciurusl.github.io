...
| <img src="/images/pages/MMA/Dancer3.png" alt="Representation of the particles in animation" style="height: 600px; width: 400px; border: none;"> | <img src="/images/pages/MMA/Dancer4.png" alt="Illustration of the collision objects" style="height: 600px; width: 400px; border: none;"> |
|----------------------------------------------------------------------------------------------------------|----------------------------------------------------------------------------------------------------------|
